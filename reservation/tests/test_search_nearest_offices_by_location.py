...
from reservation.tests.utils import create_multiple_doctors, create_office
...
class SearchNearestOfficeByLocation(TestCase):
    ...
    def test_nearest_one_to_sharif_location(self):
        office_id_list = self.search_class.get_list_of_top_office_ids(offices=self.offices,
                                                                      loc_lat=self.position['lat'],
